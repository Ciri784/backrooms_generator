...
Navigate through 8 levels of the Backrooms (Level 0-7). Each level has different entities and difficulty.
...
**Items:**
- Flashlight — Helps escape Wretches
- Painkillers — Reduces damage taken
- Almond Water — Strange effects, but useful
...
Both are self-contained static pages. All logic runs in JavaScript.
